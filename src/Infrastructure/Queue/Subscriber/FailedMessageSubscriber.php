...
class FailedMessageSubscriber implements EventSubscriberInterface
{
    ...
    public function onMessageFailed(WorkerMessageFailedEvent $event): void
    {
        ...
        // Si le message qui a échoué, est une notification,
        // on ne demande pas une nouvelle notification (cela créerait une boucle infinie)
        ...
        $redeliveryStamp = new RedeliveryStamp(1, null);

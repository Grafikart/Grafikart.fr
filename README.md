...
- Par quelles vidéos dois-je commencer ?
...
La version actuelle du site contient beaucoup de choses en dur ce qui empèche le code d'être partagé sans risque. L'objectif de cette version est donc de créer un code qui puisse être utilisé et lancé facilement par les personnes qui souhaitent collaborer.

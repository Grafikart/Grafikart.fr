            ...
            <div className="space-y-2">
                ...
                {subscription && (
                    <p className="text-muted text-sm">
                        Le renouvellement automatique est activé, vous serez
                        prélevé automatiquement à la fin de chaque période. Vous
                        pourrez interrompre l'abonnement à tout moment depuis
                        votre compte.
                    </p>
                )}
            </div>

...
export type CourseFilterTypeCount = {
  course: number
  formation: number
}
export type CourseFiltersResponse = {
  technologies: Array<CourseFilterItem>
  levels: Array<CourseFilterItem>
  types: CourseFilterTypeCount
}

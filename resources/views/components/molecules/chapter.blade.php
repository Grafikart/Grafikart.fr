...
<a href="{{ route('courses.show', ['slug' => $chapter->slug, 'course' => $chapter->id])}}#autoplay" class="{{ cn([
    ...
    @endif
    <svg class="size-6 hidden group-data-completed:block" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">

...
>
    ...
    <button
        onclick="this.parentElement.setAttribute('data-hide', ''); setTimeout(() => this.parentElement.remove(), 1000)"
        @class([
            "absolute top-0 left-0 -translate-35/100 size-5 rounded-full grid place-items-center border",
            'bg-success-bg border-success-border text-success-text' => $type === 'success',
            'bg-error-bg border-error-border text-error-text' => $type === 'error'
        ])>
